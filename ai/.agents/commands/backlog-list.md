...
Read the complete dependency graph. Show open implementation work, resumable progress, review-pending items and open implementation PRs, genuine blockers, and dependency-gated items. Order prerequisites before dependents; within the same ready wave prefer resumable or review work before new work.
