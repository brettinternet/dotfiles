...
"""
    ...
    def test_command_adapters_are_generated_without_duplicate_claude_commands(
        ...
        unmanaged_opencode_command = self.home / ".config/opencode/commands/manual.md"
        ...
        self.assertIn(
            "Generated by install-agent-commands.", generated_skill.read_text()
        )
        ...
        opencode_command = self.home / ".config/opencode/commands/pr-review-draft.md"
        self.assertIn(
    ...
    def test_remote_mutation_authority_stays_explicit(self) -> None:
        ...
        implement = (self.home / ".agents/skills/implement/SKILL.md").read_text()
        backlog = (
    ...
    def test_agent_definitions_are_generated_in_home(self) -> None:
        ...
        pi_tools = {
            ...
            "pr-watcher": "read, grep, find, ls, bash",
            "reviewer": "read, grep, find, ls",
            "thermo-nuclear-code-quality-review": "read, grep, find, ls",
            "verifier": "read, grep, find, ls, bash",
        }
        for role, tools in pi_tools.items():
            generated = (self.home / f".pi/agent/agents/{role}.md").read_text()
            self.assertIn(f"tools: {tools}\n", generated)
            self.assertIn("inheritProjectContext: true\n", generated)
            self.assertIn("inheritGlobalContext: true\n", generated)
        self.assertIn(
            "tools:\nsystemPromptMode: replace\n",
            (self.home / ".pi/agent/agents/writer.md").read_text(),
        )
        ...
        self.assertTrue((self.home / ".config/opencode/agents/reviewer.md").is_file())
        self.assertIn(
            'model = "gpt-5.6-terra"',
            (self.home / ".codex/agents/reviewer.toml").read_text(),
        )
        self.assertIn(
            "model: opus-4.6", (self.home / ".claude/agents/writer.md").read_text()
        )
        self.assertIn(
            "model: pi/writer",
        ...
        self.assertTrue((self.home / ".config/opencode/agents/writer.md").is_file())
        self.assertIn(
            'model = "gpt-5.4"',
            (self.home / ".codex/agents/writer.toml").read_text(),
        )
        codex_config = (self.home / ".codex/config.toml").read_text()
        self.assertIn("config_file", codex_config)
        self.assertEqual(
            "ctrl-q",
            tomllib.loads(codex_config)["tui"]["keymap"]["composer"]["queue"],
        )
        self.assertIn(
    ...
    def test_destructive_command_guards_are_installed_idempotently(self) -> None:
        ...
        opencode_guard.parent.mkdir(parents=True)
        opencode_guard.symlink_to(ROOT / "ai/opencode/dcg-guard.js")
        omp_guard = self.home / ".omp/agent/extensions/dcg-guard.ts"
        omp_guard.parent.mkdir(parents=True)
        omp_guard.symlink_to(ROOT / "ai/pi/extensions/dcg-guard.ts")
    ...
    def test_legacy_omp_retirement_preserves_symlinked_ownership_state(
        ...
        external_manifest.write_text("# Generated by install-agents.\nexecutor.md\n")
...
"""
    ...
    def test_agent_definitions_share_one_body_across_tools(self) -> None:
        ...
        for role in (
            ...
            opencode = self.agent_body(self.home / f".config/opencode/agents/{role}.md")
        ...
        for role in ("explore", "thermo-nuclear-code-quality-review"):
            ...
            self.assertTrue((self.home / f".omp/agent/agents/{role}.md").is_file())
            self.assertTrue((self.home / f".pi/agent/agents/{role}.md").is_file())
    ...
    def test_agent_definitions_reap_removed_roles(self) -> None:
        ...
        self.assertFalse((self.home / ".pi/agent/agents/retired.md").exists())
    ...
    def test_model_limits_are_managed_by_ai_install(self) -> None:
        ...
        claude_keybindings = self.home / ".claude/keybindings.json"
        self.assertTrue(claude_keybindings.is_symlink())
        self.assertEqual(
            (ROOT / "ai/claude/keybindings.json").resolve(),
            claude_keybindings.resolve(),
        )
        self.assertEqual(
            "chat:queueSubmit",
            json.loads(claude_keybindings.read_text())["bindings"][0]["bindings"][
                "ctrl+q"
            ],
        )
    ...
    def test_profile_rendering_writes_only_home(self) -> None:
        ...
        self.assertIn("writer: openai-codex/gpt-5.4:medium", omp_config.read_text())
    ...
    def test_openrouter_cheap_profiles_preserve_original_routes(self) -> None:
        ...
        opencode_config = json.loads(
            "\n".join(
                line for line in opencode_text.splitlines() if not line.startswith("//")
            )
        )
    ...
    def test_make_ai_is_idempotent_without_dirtying_checkout(self) -> None:
        ...
        self.assertFalse((self.home / ".config/opencode/opencode.jsonc").is_symlink())
        ...
        self.assertFalse((self.home / ".claude/commands/pr-review-draft.md").exists())
