...
local config = {
  ...
  -- vim options (vim.<first_key>.<second_key> = value)
  options = {
    opt = {
    ...
    g = {
      ...
      gruvbox_material_enable_italic = 0, -- cursive
  ...
  gruvbox_material = {
    ...
    highlights = function(hl)
      local C = require "gruvbox_material.colors"
  ...
  lsp = {
    ...
    formatting = {
      format_on_save = {
        enabled = true,
        allow_filetypes = {}, -- only certain types
        ignore_filetypes = {}, -- disable types
      },
      disabled = {}, -- target language servers
      timeout_ms = 1000,
    },
    ["server-settings"] = {
      yamlls = {
