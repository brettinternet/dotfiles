...
assert_equal(firstCanvas[1].frame.w, 796, "border width")
assert_equal(firstCanvas[1].strokeWidth, 4, "border stroke width")
...
assert_equal(firstTimer.delay, 0.8, "dismissal delay")
firstTimer.callback()
